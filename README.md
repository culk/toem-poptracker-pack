# TOEM: A Photo Adventure AP Tracker

A [PopTracker](https://github.com/black-sliver/PopTracker/) Pack for TOEM: A Photo Adventure to be used for the multiworld randomizer [Archipelago](https://archipelago.gg/). The TOEM: A Photo Adventure AP world can be found at https://github.com/bbernardoni/Archipelago.
